...
public class CarSwitcher : MonoBehaviour
{
	...
	PrimaryInputActions primaryInputActions;
    ...
    private void Awake()
	{
		...
		primaryInputActions = new PrimaryInputActions();
		primaryInputActions.Gameplay.NextVehicle.performed += ctx => HandleVehicleChange();
		primaryInputActions.Gameplay.ResetVehicle.performed += ctx => HandleVehicleReset();
		
		
		//gameplayActionMap = primaryActions.FindActionMap("Gameplay");
		
		//nextVehicleInputAction = gameplayActionMap.FindAction("Next Vehicle");
		//resetVehicleInputAction = gameplayActionMap.FindAction("Reset Vehicle");
	...
	//	nextVehicleInputAction.Enable();
		...
		primaryInputActions.Gameplay.Enable();
	}
	...
	protected void OnDisable()
	{
		...
		primaryInputActions.Gameplay.Disable();
	}
}
